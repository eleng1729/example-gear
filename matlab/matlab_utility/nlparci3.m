%function ci = nlparci3(beta,resid,varargin)
function [ci,varb,corrb,varinf] = nlparci3(beta,resid,varargin)
...
% 20020707 PJB: I downloaded this from the mathworks website. This function is
%   identical to the nlparci provided in the stats toolbox except it calcalates
%   a few more values and returns them. The modifications are marked at the end 
%   of the file
% 20191022 PJB: Re-applied these changes to the 2017b version of nlparci,
% which is less prone to singularity errors (don't now why)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MODIFICATIONS BY ARTUR JUTAN
% Var and Corr Calculation for parameters --aj May '96
