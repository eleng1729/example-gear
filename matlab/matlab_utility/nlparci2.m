...
function [ci,varb,corrb,varinf] = nlparci2(beta,resid,varargin)
...
%   $Revision: 2.12.2.7 $  $Date: 2009/05/07 18:31:50 $

% 7/7/2002 PJB: I downloaded this from the mathworks website. This function is
...
error('This version gives singular results in some cases. Use nlparci3');
